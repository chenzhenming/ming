...
<script language="javascript" type="text/javascript">
  function submitting(methodValue){
    document.venditionCreSellMsgForm.method.value=methodValue;
    document.venditionCreSellMsgForm.submit();
  }
</script>
</head>

<body>
<html:form action="/venditionCreSellMsgAction" method="post"
	focus="wareid">
	...
	<table border="0" width="77%" height="100%" bgcolor="#ffffff">
		...
		<tr>
			<td width="17%" height="25"><font size="2">出货日期</font></td>
			<td width="50%" height="25"><html:text property="selldateYear"
				size="4" /><font size="2">年</font>&nbsp;<html:text
				property="selldateMon" size="2" /><font size="2">月</font>&nbsp;<html:text
				property="selldateDay" size="2" /><font size="2">日</font> <font
				size="2">（如:19xx年xx月xx月）</font></td>
		</tr>
		<tr>
			<td width="17%" height="25"><font size="2">出货数量</font></td>
			<td width="50%" height="25"><html:text property="sellamount" /></td>
		</tr>
		<tr>
