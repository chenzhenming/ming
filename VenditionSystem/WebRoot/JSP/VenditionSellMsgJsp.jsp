...
<script language="javascript" type="text/javascript">
  function submitting(methodValue){
    document.venditionQrySellMsgForm.method.value=methodValue;
    document.venditionQrySellMsgForm.submit();
  }
</script>
<body>
<html:form method="post" action="/venditionQrySellMsgAction"
	focus="wareidMsg">
	...
	<table border="0" bgcolor="#ffffff" width="77%" height="20%">
		...
		<tr>
			<td align="center"><font size="2">出货日期:</font></td>
			<td><html:text property="selldateYear" size="4" /><font size="2">年</font>&nbsp;<html:text
				property="selldateMon" size="2" /><font size="2">月</font>&nbsp;<html:text
				property="selldateDay" size="2" /><font size="2">日</font></td>
	...
	<logic:present name="stockList" scope="request">
		...
		<table border="1" bgcolor="#ffffff" width="77%" height="76%">
			<th background="image/vback.jpg" height="20"><font size="2">出货单号</font></th>
			...
			<th background="image/vback.jpg" height="20"><font size="2">出货日期</font></th>
			<th background="image/vback.jpg" height="20"><font size="2">出货数量</font></th>
			...
			<logic:iterate name="stockList" id="qmsg"
				type="vendition.message.vo.VenditionSellVO" length="15">
				<tr>
					<td height="15" align="center"><font size="2"><bean:write 
						
						name="qmsg" property="sellid" /></font></td>
					<td height="15" align="center"><font size="2"> <bean:write
					...
					<td height="15" align="center"><font size="2"> <bean:write
						name="qmsg" property="selldate" /> </font></td>
					<td height="15" align="center"><font size="2"> <bean:write
						name="qmsg" property="sellamount" /> </font></td>
					<td height="15" align="center"><font size="2"> <bean:write
